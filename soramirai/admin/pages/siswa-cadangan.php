<div id="content1">
	...
	<FORM CLASS="form-inline" METHOD="POST" id="tombol-tambah-container">
		<a href="pages/cadangan-cetak.php" class="tombol">Cetak Siswa Cadangan</a>
	</FORM>
...
<table id="tabel-tampil">
	...
	$q_tampil_daftar = mysqli_query($db, "SELECT * FROM tbuser WHERE status='Cadangan'");
	...
	<tr>
		...
		<td>
			<div style='padding:2px' class="tombol-opsi-container"><a target="_blank" href="pages/cadangan-kartu.php?id=<?php echo $r_tampil_daftar['id_user'];?>" class="tombol">Cetak Kartu</a></div>
			<div style='padding:2px' class="tombol-opsi-container"><a href="index.php?page=cadangan-edit&id=<?php echo $r_tampil_daftar['id_user'];?>" class="tombol">Edit</a></div>
...
<?php
	$jml = mysqli_num_rows(mysqli_query($db, "SELECT * FROM tbuser WHERE status='Cadangan'"));
...
<?php
	...
	for($i=1; $i<=$jml_page; $i++){
		if($i != $page){
			echo "<a href=\"?hal=siswa-cadangan&p=$i\">$i</a>";
		}
		else {
